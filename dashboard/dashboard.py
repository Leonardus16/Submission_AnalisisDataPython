...
st.markdown("""
    <h1 style="text-align: center; color: #2c3e50; animation: fadeIn 1s;">
        Bike Sharing Analytics Dashboard 🚲
    </h1>
    <p style="text-align: center; color: #7f8c8d;">
        Analisis data peminjaman sepeda berdasarkan faktor lingkungan dan pola waktu.<br>
        <small>Powered by Streamlit | Dibuat oleh Leonardus Adi Widjayanto</small>
    </p>
    <style>
    @keyframes fadeIn {
        from { opacity: 0; }
...
# Footer
st.markdown("---")
st.markdown('<p style="text-align: center; color: #7f8c8d;">© 2025 Leonardus Adi Widjayanto | Email: leonardusadi16@gmail.com</p>', unsafe_allow_html=True)
